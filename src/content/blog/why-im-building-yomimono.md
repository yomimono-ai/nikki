...
The core idea is calibration: Yomimono works from a model of what you already know — right now, anchored to where you are in your studies — and generates passages built mostly from that, long enough to let you settle into a rhythm. Read enough of them and you build real reading reflexes. It's deliberately simple, and it sits alongside the textbook you're already using.
